    ...
    useEffect(() => {
        const fetchMovieDetails = async () => {
            try {
                ...
                const creditsResponse = await axios.get(`https://api.themoviedb.org/3/movie/${movieId}/credits?api_key=${TMDB_API_KEY}&language=pt-BR`);
    ...
    return (
        <ScrollView style={styles.container}>
            <View style={styles.backgroundContainer}>
                <Image source={{uri: `https://image.tmdb.org/t/p/w500${movieDetails.backdrop_path}`}} style={styles.backgroundImage} />
            </View>
            <View style={styles.contentContainer}>
                ...
                <View style={styles.movieContainer}>
                    ...
                    <View style={styles.textContainer}>
                        ...
                        <Text style={styles.subtitle}>DIRIGIDO POR: <Text style={styles.director}>{movieDetails.director}</Text></Text>
                        <Text style={styles.subtitle}>DURAÇÃO: <Text style={styles.director}>{formatRuntime(movieDetails.runtime)}</Text></Text>
                    </View>
                </View>
                ...
                <View style={styles.cast}>
                    ...
                    <Text key={actor.id} style={styles.actorName}>{actor.name} como {actor.character}</Text>
                    ))}
                </View>
            </View>
        </ScrollView>
